...
@section('content')
    <div class="dynamic-content">
        <div class="alert alert-success " role="alert">
            <span><h4><b>ویرایش رئیس کمیته</b></h4></span>
        </div>

        {!! Form::model($result,['route'=>['comiteRaes.update',$result->id], 'method'=>'put']) !!}
        ...
        <div class="form-container">
            ...
            <div class="form-group-row row" >
                <div class="form-group-cell col">
                    {!! Form::label('code', 'کد') !!}
                    {!! Form::text('code',old('code') ,['placeholder'=>'']) !!}
                    @error('code')
                    <p class="text-danger my-2">{{$message}}</p>
                    @enderror
                </div>
            ...
            <div class="form-group-row" style="text-align: left">
                ...
                <div class="form-group-cell">
                    <a href="{{route('comiteRaes.index')}}" ><button type="button" class="admin-panel-btn btn-blue" style="float:left">بازگشت به لیست</button></a>
                </div>
            </div>
        </div>
